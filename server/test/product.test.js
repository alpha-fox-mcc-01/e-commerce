...
describe('product routing', function() {
    describe('/products', function() {
        ...
        // it('should have status 200 and return an array of products in the products database', function(done) {
        //     chai.request(app)
        //         .get('/products')
        //         .end((err, res) => {
        ...
        //         })
        // })
        // it('should have status 200 and return an array of categories in the products database', function(done) {
        //     chai.request(app)
        ...
        //         })
        // })
        // it('should have status 200 and return an array of products(objects) in the products database under a certain category', function(done) {
        //     chai.request(app)
        //         .get('/products/categories/Sportswear')
        //         .end((err, res) => {
        //             expect(res.body).to.be.an('array')
        //             expect(res.body[0].category).to.equal('Sportswear')
        //             done()
        //         })
        // })
    })
